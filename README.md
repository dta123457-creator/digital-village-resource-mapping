# 🗺️ Digital Village Resource Mapping

**AI-powered GIS platform for Smart India Hackathon - Village resource mapping and infrastructure analysis**
...
- Confidence scoring for predictions (92.5% accuracy)
...
```python
from app.ml.detector import ResourceDetector

# Initialize detector
detector = ResourceDetector(model_path="models/resource_detector.h5")

# Detect resources in satellite image
detections = detector.detect_resources(satellite_image)

# Access detection results
for detection in detections:
    print(f"{detection['resource_type']}: {detection['confidence']}")
```
...
- 🐛 Issues: [GitHub Issues](https://github.com/dta123457-creator/digital-village-resource-mapping/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/dta123457-creator/digital-village-resource-mapping/discussions)
